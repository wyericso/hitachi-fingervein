...
curl -w "\n" -H "Content-Type:application/json" -d@/home/eric/index_l.json "http://localhost:8080/api/send_template"
curl -w "\n" -H "Content-Type:application/json" -d@/home/eric/middle_l.json "http://localhost:8080/api/send_template"
curl -w "\n" -H "Content-Type:application/json" -d@/home/eric/ring_l.json "http://localhost:8080/api/send_template"
curl -w "\n" -H "Content-Type:application/json" -d@/home/eric/pinky_l.json "http://localhost:8080/api/send_template"
